...
set(MYSQLCPPCONN_CONFIGURE cd ${MYSQLCPPCONN_ROOT}/src/mysqlcppconn-${MYSQLCPPCONN_VER} && mkdir -p build && cd build && cmake ..)
...
add_dependencies(mysqlcppconn-${MYSQLCPPCONN_VER} mysqlcppconn-${MYSQLCPPCONN_VER})
