...
set(BOOST_BUILD         cd ${BOOST_ROOT}/src/boost-${BOOST_VER} && ./b2 variant=release link=static threading=multi runtime-link=shared address-model=64 cxxflags=-fPIC install -j4)
